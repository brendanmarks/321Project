...
public class TutoringSystemService {
	...
	/*
	@Transactional
	public List<Tutorial> getTutorialsAttendedByTutor(Tutor tutor) {
		List<Tutorial> tutorialsAttendedByPerson = new ArrayList<>();
		for(Session s : sessionRepository.findById(id))
